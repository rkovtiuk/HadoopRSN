...
// cc AvroGenericMaxTemp MapReduce program to find the maximum temperature, creating Avro output
...
//vv AvroGenericMaxTemp
public class AvroGenericMaxTemp extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.getConfiguration().setBoolean(
                Job.MAPREDUCE_TASK_CLASSPATH_PRECEDENCE, true);
