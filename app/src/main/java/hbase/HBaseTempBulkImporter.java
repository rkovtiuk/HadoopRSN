 ...
 */
public class HBaseTempBulkImporter extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    if (args.length != 1) {
      System.err.println("Usage: HBaseTempBulkImporter <input>");
      return -1;
    }
  ...
  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(HBaseConfiguration.create(),
        new HBaseTempBulkImporter(), args);
