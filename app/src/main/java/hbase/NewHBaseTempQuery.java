...
/**
 * HBase 1.0 version of HBaseTempQuery that uses {@code Connection},
 * and {@code Table}.
 */
public class NewHBaseTempQuery extends Configured implements Tool {
  ...
  public int run(String[] args) throws IOException {
    if (args.length != 1) {
      System.err.println("Usage: HBaseTempQuery <station_id>");
      return -1;
    }
