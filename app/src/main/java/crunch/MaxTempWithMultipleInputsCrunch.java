...
// Crunch version of ch08-mr-types MaxTempWithMultipleInputsCrunch
// TODO: sanity check output
public class MaxTempWithMultipleInputsCrunch {

    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: MaxTempWithMultipleInputsCrunch <ncdc input> <metoffice input> <output>");
            System.exit(-1);
        }

        Pipeline pipeline = new MRPipeline(MaxTempWithMultipleInputsCrunch.class);
